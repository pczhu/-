 ...
 * @version 1.0, @d2013-3-2 下午11:02:11
 * 
 * @(#)UploadServlet.java
 * 
...
public class UploadServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        try {
            ...
            String uploadPath = getServletContext().getRealPath("/uploadFile/driverLog/");
            ...
            for (FileItem item : items) {
                ...
                // 处理上传文件
                    ...
                    filename = get(System.currentTimeMillis())+"-"+item.getName().substring(item.getName().lastIndexOf("\\") + 1);
                    is = item.getInputStream(); // 得到上传文件的InputStream对象
                }
            }
            // 将路径和上传文件名组合成完整的服务端路径
            // filename = uploadPath + File.separator + BOUNDARY + "_" +
            // filename;
	...
	public String get(long beginDate){
